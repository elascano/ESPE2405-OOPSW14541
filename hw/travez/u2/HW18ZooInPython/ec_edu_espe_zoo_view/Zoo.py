...
if __name__ == "__main__":
    ...
    lion_pedro = Lion(True, 1, "Lion 1", datetime(2024, 10, 10), 'f', 0, cage_felines)
    ...
    lion_juancho = Lion(False, 2, "Lion 2", datetime(2024, 5, 3), 'm', 0, cage_felines)
    lion_juancho.feed(4)
    animals.append(lion_juancho)
    print("Animal (lion) -->", lion_juancho)
    
    shark_pepe = Shark(1, "Shark 1", datetime(2024, 6, 7), 'm', 0, pool)
    shark_pepe.feed(6)
