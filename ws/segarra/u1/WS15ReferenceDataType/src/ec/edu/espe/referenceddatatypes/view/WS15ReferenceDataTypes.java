 ...
 */
package ec.edu.espe.referenceddatatypes.view;

import ec.edu.espe.referenceddatatypes.model.Professor;

/**
 *
 * @author Eduardo Segarra, TheJavaBandits, DCCO-ESPE
 */
public class WS15ReferenceDataTypes {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        System.out.println("Eduardo Segarra primitives and referenced data types");
        float salary;
        Professor professor = new Professor(1, 53, 4078.0F, "Edison");
        salary = 2851;
