...
/**
 *
 * @author Cristian Lisintuña, JavaSquad, DCCO-ESPE
 */
public class Zoo {
    public static void main(String[] args) {
        System.out.println("Cristian's Zoo");
        ...
        Lion lion = new Lion(true, 1, "Lion Alex", new Date(2024, 10, 10), 'f', 0, cageFelines);
        ...
        System.out.println("Animals in Cristian's Zoo --> \n " + animals);
