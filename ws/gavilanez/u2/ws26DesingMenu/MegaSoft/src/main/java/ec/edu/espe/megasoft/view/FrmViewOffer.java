 ...
 */
public class FrmViewOffer extends javax.swing.JFrame {

    /**
     * Creates new form FrmViewOffer
     */
    public FrmViewOffer() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmViewOffer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmViewOffer().setVisible(true);
            }
        });
    }
