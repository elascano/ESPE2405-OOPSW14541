...
public class MongoManager {
    ...
    public static boolean create(Animal animal) {
        ...
        // Cambia este URI para conectarte a tu MongoDB en la nube
        String uri = "mongodb+srv://EnzoArmijos:EnzoArmijos@cluster0.t8g9ujs.mongodb.net/";

        MongoDatabase dataBase = openConnectionToMongo(uri);
        Document dataOfAnimal = new Document()
            .append("id", animal.getId())
            .append("descripción", animal.getDescription())
        ...
        return true; // Cambiado a true si la inserción es exitosa
    }
