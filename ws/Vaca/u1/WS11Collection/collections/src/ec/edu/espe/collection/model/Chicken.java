...
public class Chicken {
    ...
    public String toString() {
        return "chicken{" + "id=" + getId() + ", color=" + getColor() + ", name=" + getName() + ", age=" + getAge() + ", molting=" + isMolting() + ", bornOnYear=" + getBornOnYear() + ", bornOnMonth=" + getBornOnMonth() + ", bornOnDay=" + getBornOnDay() + '}';
    }
