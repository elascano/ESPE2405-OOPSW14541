...
def save_to_mongodb(data: List[int], sorted_data: List[int]):
    client = MongoClient("mongodb+srv://logiclegion:logiclegion123@cluster0.pkfbgix.mongodb.net/")
    db = client.strategyAyuquina
    collection = db.arrayAyuquina
...
def main():
    ...
    input_data = input("Introduce una lista de números separados por comas (ej. 5,3,8,1): ")
    ...
    save_to_mongodb(data, sorted_data)
